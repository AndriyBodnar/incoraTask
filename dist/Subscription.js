    ...
    getRecommendationTrending() {
        return this.streamingService.getMostViewedShowsOfYear() !==
            ...
            ? this.streamingService
                ...
                .getRecommendation(this.streamingService.getMostViewedShowsOfYear().length)
    ...
    getRecommendationByGenre(genre) {
        return this.streamingService.getMostViewedShowsOfGenre(genre) !==
            ...
            ? this.streamingService
                ...
                .getRecommendation(this.streamingService.getMostViewedShowsOfGenre(genre).length)
            : warningOrange(`Empty recommendations by genre`);
    }
}
// declare global {
//   interface Array<T> {
//     getRecommendation(length: number): any[] | T[];
//   }
// }
Array.prototype.getRecommendation = function (length) {
    const thisArray = this;
    return thisArray.sort((a, b) => +b.getDuration().split(" min")[0] - +a.getDuration().split(" min")[0])[randomNumber(0, length - 1)];
};
